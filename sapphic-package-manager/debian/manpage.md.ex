% sapphic-package-manager(SECTION) | User Commands
%
% "March  3 2024"
...
sapphic-package-manager - program to do something

# SYNOPSIS

**sapphic-package-manager** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sapphic-package-manager** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sapphic-package-manager** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sapphic-package-manager** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sapphic-package-manager. See **foo.conf**(5) for further details.
...
**sapphic-package-manager** provides some return codes, that can be used in scripts:
